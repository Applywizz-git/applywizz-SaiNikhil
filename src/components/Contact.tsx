      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 font-['Inter'] max-w-2xl mx-auto">
            Looking for an experienced Java Full Stack Developer? Let's connect and discuss how I can contribute to your team.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.a
              href="https://www.linkedin.com/in/sai-nikhil-pothuraju-5399111a9/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <motion.a
              href="mailto:pothuraju.sainikhil22@gmail.com"
              whileHover={{ scale: 1.03, x: 5 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">pothuraju.sainikhil22@gmail.com</p>
              </div>
            </motion.a>
          </motion.div>
