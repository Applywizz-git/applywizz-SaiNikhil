  ...
  const skillCategories = [
    {
      ...
      skills: ['Java', 'Spring Boot', 'Spring MVC', 'Spring Cloud', 'Spring Security', 'Hibernate', 'Microservices', 'GraphQL', 'Event-Driven Arch'],
      color: 'from-[#F45D48] to-[#ff7b6a]',
    },
    {
      icon: LineChart,
      title: 'Frontend Engineering',
      skills: ['Angular 17/15/13', 'ReactJS', 'TypeScript', 'JavaScript (ES6+)', 'HTML5', 'CSS3', 'SCSS', 'Bootstrap', 'UI Design'],
      color: 'from-[#6EE7B7] to-[#8ef5d1]',
    },
    {
      icon: Cloud,
      title: 'Cloud & Serverless',
      skills: ['AWS (Lambda, ECS, S3)', 'DynamoDB', 'API Gateway', 'SQS/SNS', 'Terraform', 'Kubernetes (K8s)', 'Helm'],
      color: 'from-[#F45D48] to-[#6EE7B7]',
    },
    {
      icon: Server,
      title: 'Messaging & Streaming',
      skills: ['Apache Kafka', 'Kafka Streams', 'RabbitMQ', 'JMS', 'Async Patterns'],
      color: 'from-[#6EE7B7] to-[#F45D48]',
    },
    {
      icon: Database,
      title: 'Databases & Storage',
      skills: ['PostgreSQL', 'Oracle', 'MongoDB', 'Redis', 'DynamoDB', 'SQL/PL-SQL', 'Query Optimization'],
      color: 'from-[#ff7b6a] to-[#F45D48]',
    },
    {
      icon: Puzzle,
      title: 'DevOps & Tooling',
      skills: ['Docker', 'Kubernetes', 'Jenkins', 'GitLab CI/CD', 'GitHub Actions', 'Maven/Gradle', 'Prometheus', 'Grafana'],
      color: 'from-[#8ef5d1] to-[#6EE7B7]',
    },
    {
      icon: Code,
      title: 'Testing & Quality',
      skills: ['JUnit', 'Mockito', 'REST Assured', 'Postman', 'Selenium', 'TDD', 'JMeter'],
      color: 'from-[#F45D48] to-[#ff7b6a]',
    },
    {
      icon: Server,
      title: 'Monitoring & Collab',
      skills: ['Git', 'SonarQube', 'ELK Stack', 'Splunk', 'Swagger/OpenAPI', 'JIRA', 'Confluence', 'Log4j/SLF4J'],
      color: 'from-[#6EE7B7] to-[#8ef5d1]',
    },
    {
      icon: Cloud,
      title: 'System Design',
      skills: ['Distributed Systems', 'DDD', 'OAuth2/JWT', 'Cloud-Native', 'DevSecOps', 'High Availability'],
      color: 'from-[#F45D48] to-[#6EE7B7]',
    },
  ];
