...
export const About = () => {
  ...
  const stats = [
    ...
    { icon: Target, value: 20, suffix: '+', label: 'Distributed Systems' },
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          >
            Sai Nikhil Pothuraju is a Java Full Stack Developer with 7+ years of experience in building cloud-native, event-driven, and distributed platforms. He specializes in designing and deploying Spring Boot microservices, Kafka/RabbitMQ pipelines, and secure OAuth2/JWT APIs.
          </motion.p>
          ...
          >
            Skilled in modernizing enterprise landscapes, he has delivered scalable solutions on AWS and GCP, improved application performance using Hibernate and Redis, and strengthened engineering delivery through CI/CD automation and DevSecOps practices.
          </motion.p>
        </div>
