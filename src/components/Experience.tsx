  ...
  const experiences = [
    {
      ...
      achievements: [
        'Designed cloud-native payment microservices using Java 17, Spring Boot, and AWS ECS, cutting API response time by 32%.',
        'Modeled payment workflows with Spring Cloud & Kafka Streams, boosting throughput by 40% under peak load.',
        'Built REST and GraphQL APIs using OpenAPI, unifying data access for mobile and risk teams.',
        'Secured endpoints with OAuth2, JWT, and Spring Security, reducing unauthorized access incidents by 52%.',
        'Delivered automated reconciliation pipelines using Spring Batch and PostgreSQL, increasing ledger accuracy.',
        'Implemented geo-risk analytics with Kafka Streams and DynamoDB, accelerating fraud detection by 28%.',
      ],
    },
    {
      ...
      achievements: [
        'Revamped payment validation flows with Java 11/Spring Boot/AWS Lambda, cutting validation time by 30%.',
        'Migrated billing modules to AWS EC2/S3, increasing system uptime.',
        'Automated settlement pipelines with Spring Batch, reducing operational workload by 70%.',
        'Built secure partner connectors with OAuth2 and TLS, strengthening PCI compliance.',
        'Configured Kafka for real-time transaction streaming, improving fraud-analytics accuracy.',
        'Delivered operational dashboards using Angular 11, TypeScript, and RxJS.',
      ],
    },
    {
      title: 'Java Full Stack Developer',
      ...
      achievements: [
        'Developed configurable workflow modules using Angular 11, TypeScript, and RxJS.',
        'Delivered backend automation services in Java 11/Spring Boot, lowering support tickets by 25%.',
        'Created Spring Batch pipelines for inspections, raising automation coverage to over 70%.',
        'Implemented Kafka-based event streams, reducing response delays by 28%.',
        'Optimized backend performance through Hibernate tuning, cutting slow query execution by 30%.',
      ],
    },
    {
      ...
      achievements: [
        'Engineered REST microservices using Java 8, Spring Boot, and Hibernate, improving response speed by 40%.',
        'Transitioned workflows to AWS EC2 and RDS, increasing system scalability by 40%.',
        'Built modular UI components with Angular 7, enhancing portal responsiveness.',
        'Introduced asynchronous processing via RabbitMQ, smoothering registration handling during spikes.',
      ],
    },
    {
      ...
      achievements: [
        'Built high-throughput messaging components using Java 8, Spring MVC, and Hibernate.',
        'Integrated carrier interfaces using JAX-RS and JAX-WS, reducing failed delivery handoffs.',
        'Optimized retrieval performance through Hibernate caching and HQL tuning.',
        'Configured JMS queues for asynchronous processing, lowering message-drop incidents.',
      ],
    },
  ];
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          {experiences.map((exp, i) => (
            <motion.div
              ...
              animate={isInView ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.6, delay: i * 0.2 }}
              className={`relative mb-14 sm:mb-16 ${i % 2 === 0
                  ? 'md:pr-[50%] md:text-right md:pl-0'
                  : 'md:pl-[50%] md:text-left md:pr-0'
                }`}
            >
              <div
                className={`ml-10 sm:ml-16 md:ml-0 ${i % 2 === 0 ? 'md:mr-10' : 'md:ml-10'
                  }`}
              >
                <motion.div
                  whileHover={{ scale: 1.02, y: -5 }}
