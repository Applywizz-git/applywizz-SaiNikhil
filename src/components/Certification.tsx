...
export const Certification = () => {
  ...
  const certifications = [
    ...
    {
      title: 'VMware Spring Professional Certification',
      provider: 'VMware',
      icon: '🍃',
    },
    {
    ...
    {
      title: 'Building Scalable Java Microservices on Kubernetes',
      provider: 'Coursera',
      icon: '🏗️',
    },
    {
    ...
    {
      title: 'Developing Applications with Java and Spring Boot',
      provider: 'Coursera',
      icon: '💻',
    },
  ];
